      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ac-left {
          ...
          z-index: 2;
          overflow-y: auto;
          /* subtle right shadow separating panels */
        ...
        .ac-left::before {
          ...
          border-radius: 50%;
          background: radial-gradient(circle, rgba(255,215,0,0.08) 0%, transparent 68%);
          pointer-events: none;
        }
      ...
      <div className="ac-root">
        ...
        <div className="ac-left">
          ...
          <div className="brand-row">
            <div className="brand-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="#FFD700" style={{ position: "relative", zIndex: 1 }}>
            ...
            <div>
              ...
              <div className="brand-meta">
                Engineering Pvt. Ltd. — ERP System<br />
          ...
          <div className="ac-hint">
            <p>
              <strong>Need access?</strong> All user accounts are provisioned by your system
              administrator. Reach out to your IT team for new credentials, password resets, or role changes.
            </p>
          ...
          <div className="ac-footer">
            © 2025 Accura Precision Engineering Pvt. Ltd. · All rights reserved
          </div>
        </div>

        {/* ══════════ RIGHT: Lottie + Content ══════════ */}
        <div className="ac-right">
          ...
          <div className="ac-right-text">
            <h2>
              Your Factory's Brain,<br />
              Powered by <span>Accura Core</span>
            </h2>
            <p className="sub">
              From <strong>raw material procurement</strong> to <strong>finished goods dispatch</strong> —
              every step of your manufacturing process is tracked, optimised, and
              visible in real time. Built exclusively for precision engineering shops.
            </p>
          </div>

          {/* Feature pills */}
          <div className="ac-pills">
            {["Production Planning", "Inventory Control", "Purchase Orders", "Dispatch & Logistics", "Quality Tracking"].map(f => (
              <span className="ac-pill" key={f}>
